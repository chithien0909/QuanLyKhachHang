...
{
    public partial class QLHDTheoKH : Form
    {
        ...
        void LoadData(string MaKhachHang)
        {
            try
            {
                ...
                daHD = new SqlDataAdapter("SELECT * FROM HoaDon Where MaKH = '" + MaKhachHang+ "'", conn);
                dtHD = new DataTable();
                dtHD.Clear();
                daHD.Fill(dtHD);
                ...
                cbKH.DisplayMember = "TenCty";
                cbKH.ValueMember = "MaKH";
                cbKH.SelectedValue = MaKhachHang;
        ...
        private void QLHDTheoKH_Load(object sender, EventArgs e)
        {
            LoadData("AGROMAS");
        }
        ...
        {
            string MaKhachHang = this.cbKH.SelectedValue.ToString();
